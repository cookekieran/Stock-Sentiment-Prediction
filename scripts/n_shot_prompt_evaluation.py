...
def args() -> argparse.Namespace:
    ...
    # Old prompt-eval logs refer to this dataset by its old filename:
    # mag7_headline_relevance_hard_audit_420_relabelled_clean.csv
    parser.add_argument("--audit-csv", default="data/headline_filtering_manual_audit.csv")
...
def main() -> None:
    ...
    audit_path = Path(run_args.audit_csv)
    if not audit_path.is_absolute():
        audit_path = REPO_ROOT / audit_path

    audit = load_audit(audit_path, run_args.max_rows)
